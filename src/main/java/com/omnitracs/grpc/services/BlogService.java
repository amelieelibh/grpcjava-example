...
import com.omnitracs.proto.blog.Blog;
import com.omnitracs.proto.blog.BlogServiceGrpc.BlogServiceImplBase;
import com.omnitracs.proto.blog.CreateBlogRequest;
import com.omnitracs.proto.blog.CreateBlogResponse;
import com.omnitracs.proto.blog.DeleteBlogRequest;
import com.omnitracs.proto.blog.DeleteBlogResponse;
import com.omnitracs.proto.blog.ListBlogRequest;
import com.omnitracs.proto.blog.ListBlogResponse;
import com.omnitracs.proto.blog.ReadBlogRequest;
import com.omnitracs.proto.blog.ReadBlogResponse;
import com.omnitracs.proto.blog.UpdateBlogRequest;
import com.omnitracs.proto.blog.UpdateBlogResponse;
...
public class BlogService extends BlogServiceImplBase {

    private MongoClient mongoClient = MongoClients.create("mongodb+srv://ameliebh:Amelie_11@mongoameliecluster-bx74j.azure.mongodb.net/test?retryWrites=true&w=majority");
    private MongoDatabase database = mongoClient.getDatabase("proto");
